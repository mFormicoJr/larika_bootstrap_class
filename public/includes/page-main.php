<!-- Classe .containter serve basicamente para conter, centralizar e aplicar largura máxima
            ...
            Ele utiliza aquele esquema de breakpoints que expliquei anteriormente
            Por exemplo -> tela com os tamanhos
         -->
        ...
        <main class="container p-3">
            ...
            <div class="row">
                <div class="col"> <!-- col = column -->
                    ...
                    <!-- classe .card basicamente criar uma "caixa" com estilos para bordar, cantos arredondados e cor do fundo -->
                    <div class="card text-white bg-warning">
                        ...
                        <!-- Basicamente aplica um padding dentro do card para os textos não ficarem nas bordas
